                                            ...
                                            <form id="sib-form" method="POST"
                                                ...
                                                <div class="form-content_fieldset form-get_email">
                                                            ...
                                                            <div class="form__entry entry_block">
                                                                <div class="form__label-row ">
                                                                    ...
                                                                    <div class="entry__field ip">
                                                                        <input class="input style-stroke-2" type="email" id="EMAIL"
                                                    ...
                                                    <div class="fiedset-button_submit">
                                                        <div class="sib-form-block">
                                                            <button
                                                                class="sib-form-block__button sib-form-block__button-with-loader tf-btn btn-white animate-btn animate-dark type-small-2"
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="inner-bottom">
                <ul class="list-hor">
                    <li>
                        <a href="faq.html" class="h6 link text-main">Help & FAQs</a>
                    </li>
                    <li class="br-line type-vertical"></li>
                    <li>
                        <a href="faq.html" class="h6 link text-main">Factory</a>
                    </li>
                </ul>
