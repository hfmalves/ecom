                    ...
                    <form class="form_search-product">
                        <div class="select-category">
                            <select name="product_cat" id="product_cat" class="dropdown_product_cat">
                                ...
                                <option class="level-0" value="beauty-tools-accessories">Beauty tools & accessories</option>
                                <option class="level-0" value="natural-beauty">Natural beauty</option>
                                <option class="level-0" value="baby-kids-care">Baby & Kids Care</option>
                                <option class="level-0" value="eye-care">Eye care</option>
                            </select>
                            <ul class="select-options">
                                <li class="link" rel=""><span>All categories</span></li>
                                <li class="link" rel="skincare"><span>Skincare</span> </li>
                                <li class="link" rel="makeup"><span>Makeup</span></li>
                                <li class="link" rel="haircare"><span>Haircare</span></li>
                                <li class="link" rel="body-care"><span>Body care</span></li>
                                <li class="link" rel="fragrances"><span>Fragrances</span></li>
                                <li class="link" rel="lip-care"><span>Lip care</span></li>
                                <li class="link" rel="nail-care"><span>Nail care</span></li>
                                <li class="link" rel="beauty-tools-accessories"><span>Beauty tools & accessories</span></li>
                                <li class="link" rel="natural-beauty"><span>Natural beauty</span></li>
                                <li class="link" rel="baby-kids-care"><span>Baby & Kids Care</span></li>
                                <li class="link" rel="eye-care"><span>Eye care</span></li>
                            </ul>
                        </div>
                        <span class="br-line type-vertical"></span>
                        <input class="style-def" type="text" placeholder="Search for products...">
                    </form>
                </div>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="sub-menu mega-menu mega-home">
                            <div class="container">
                                <div class="row-demo">
                                    <div class="demo-item">
                                        <a href="index-2.html" class="demo-img">
                                            <img src="images/demo/home-fashion-1.jpg" alt="Demo">
                                        </a>
                                        <a href="index-2.html" class="demo-name">Home Fashion 1</a>
                                    </div>
                                    <div class="demo-item">
                                        ...
                                        <ul class="list-hor">
                                            <li class="wg-cls hover-img">
                                                <a href="shop-default.html" class="image img-style">
                                                    <img src="images/products/cosmetic/product-9.jpg"
                                                         data-src="images/products/cosmetic/product-9.jpg" alt="Collection" class="lazyload">
                                                </a>
                                                <div class="cls-content">
                                                    <h4 class="tag_cls">Skincare</h4>
                                                    <span class="br-line type-vertical"></span>
                                            ...
                                            <li class="wg-cls hover-img">
                                                <a href="shop-default.html" class="image img-style">
                                                    <img src="images/products/cosmetic/product-16.jpg"
                                                         data-src="images/products/cosmetic/product-16.jpg" alt="Collection" class="lazyload">
                                                </a>
                                                <div class="cls-content">
                                                    <h4 class="tag_cls">Makeup</h4>
                                                    <span class="br-line type-vertical"></span>
                                                    <a href="shop-default.html" class="tf-btn-line">
                                                        Shop now
                                                    </a>
                                            ...
                                            <ul class="list-ver">
                                                <li class="prd-recent hover-img">
                                                    <a href="product-detail.html" class="image img-style">
                                                        <img src="images/category/cate-12.jpg" data-src="images/category/cate-12.jpg" alt=""
                                                             class="lazyload">
                                                    </a>
                                                    <div class="content">
                                                        <span class="badge-tag">Bodycare</span>
                                                        <a href="product-detail.html" class="name-prd h6 fw-medium link">
                                                            Radiant Glow Body Cream for Deep Skin Nourishment and Lasting Softness
                                                        </a>
                                                ...
                                                <li class="prd-recent hover-img">
                                                    <a href="product-detail.html" class="image img-style">
                                                        <img src="images/category/cate-13.jpg" data-src="images/category/cate-13.jpg" alt=""
                                                             class="lazyload">
                                                    </a>
                                                    <div class="content">
                                                        <span class="badge-tag">Haircare</span>
                                                        <a href="product-detail.html" class="name-prd h6 fw-medium link">
                                                            Lustrous Shine Hair Mask with Argan Oil and Keratin for Intense Repair
                                                        </a>
                                                        <span class="price-wrap h6 fw-semibold text-black">
                                                                            $69,99
                                                                        </span>
