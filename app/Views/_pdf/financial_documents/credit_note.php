...
<p><strong>Documento original:</strong> Fatura <?= esc($document['reference'] ?? '—') ?></p>
...
<p><em><?= esc($document['notes'] ?? 'Documento emitido para regularização de fatura anterior.') ?></em></p>
</body>
</html>
